...
insert into schedule values (default, 'admin', '2024-05-3','모임', '초등학교동창회');
insert into schedule values (default, 'admin', '2024-05-4','학습', '프로젝트기획');
insert into schedule values (default, 'admin', '2024-05-4','기타', '병원예약');
insert into schedule values (default, 'admin', '2024-05-4','업무', '기획팀 5월 정기총회');
insert into schedule values (default, 'admin', '2024-05-9','업무', '소득세 신고서 작성');
insert into schedule values (default, 'admin', '2024-05-14','모임', '초등학교동창회');
insert into schedule values (default, 'admin', '2024-05-14','모임', '초등학교동창회');
insert into schedule values (default, 'admin', '2024-05-18','학습', '자바프로그램 복습');
insert into schedule values (default, 'admin', '2024-05-20','업무', '담당자 미팅');
insert into schedule values (default, 'admin', '2024-05-20','모임', '가족모임');
insert into schedule values (default, 'admin', '2024-05-20','여행', '제주도여행');
insert into schedule values (default, 'admin', '2024-05-22','모임', '친구모임');
insert into schedule values (default, 'admin', '2024-05-24','학습', '프로젝트 제안서 제출');
insert into schedule values (default, 'admin', '2024-05-24','학습', '프로젝트 설계');
insert into schedule values (default, 'admin', '2024-05-24','기타', '치과예약');
insert into schedule values (default, 'admin', '2024-05-24','모임', '고등학교 동창회');
insert into schedule values (default, 'admin', '2024-05-25','여행', '한라산 등반');
