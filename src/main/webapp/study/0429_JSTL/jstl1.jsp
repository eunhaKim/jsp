...
<div class="container">
  ...
  <p>단점 2 : EL조건문에는 else가 없다.</p>
  <p>단점 1 : jstl의 숫자비교는 문자형식으로 비교한다.</p>
  ...
  <div>6. su3 <= su4 : <c:if test="${su3<=su4}"> su3가 su4보다 작거나 같다.</c:if><br/></div>
  ...
  <div>13. su3 > su4 : <c:if test="${su3 > su4}"> 13.su3가 su4보다 크다.</c:if></div><!-- 문자비교해서 결과가 다르게 나옴..3과4비교.. -->
  <div>14. su3 < su4 : <c:if test="${su3 < su4}"> 14.su3가 su4보다 작다.</c:if></div>
  <div>113. su3 gt su4 : <c:if test="${su3+0 gt su4+0}"> 113.su3가 su4보다 크다.</c:if></div><!-- 숫자비교는 0을 더해주고 비교해야된다.!! -->
  <div>114. su3 lt su4 : <c:if test="${su3+0 lt su4+0}"> 114.su3가 su4보다 작다.</c:if></div>
  <div>1113. su3 ge su4 : <c:if test="${su3+0 ge su4+0}"> 1113.su3가 su4보다 크거나 같다.</c:if></div><!-- 숫자비교는 0을 더해주고 비교해야된다.!! -->
  <div>1114. su3 le su4 : <c:if test="${su3+0 le su4+0}"> 1114.su3가 su4보다 작거나 같다.</c:if></div>
  <br/>
