...
%>
<jsp:useBean id="vo" class="study.j0426.T02VO" /> <!-- 클래스 변수명 -->
<!-- 
...
<head>
	...
	<%-- 
	<jsp:setProperty property="name" name="vo" /> <!-- 변수명이 같을때 생략가능 -->
...
<div class="container">
  ...
  <p>hostIp : <jsp:getProperty property="hostIp" name="vo"/> </p>
  <hr/>
  <p><a href="t02.jsp" class="btn btn-success">돌아가기</a></p>
</div>
<p><br/></p>
